...
template <> constexpr inline auto SystemController::qt_create_metaobjectdata<qt_meta_tag_ZN16SystemControllerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'mqttDisconnected'
        QtMocHelpers::SlotData<void()>(10, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'onMqttMessageReceived'
        QtMocHelpers::SlotData<void(const QByteArray &, const QMqttTopicName &)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QByteArray, 12 }, { 0x80000000 | 13, 14 },
        }}),
        // Slot 'errorOccured'
        QtMocHelpers::SlotData<void(QMqttClient::ClientError)>(15, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 16, 3 },
        }}),
        // Slot 'publishFanState'
    ...
    QtMocHelpers::UintData qt_properties {
        // property 'temp'
        QtMocHelpers::PropertyData<double>(19, QMetaType::Double, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet | QMC::Final, 0),
    };
...
void SystemController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->mqttConnected(); break;
        case 6: _t->mqttDisconnected(); break;
        case 7: _t->onMqttMessageReceived((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QMqttTopicName>>(_a[2]))); break;
        case 8: _t->errorOccured((*reinterpret_cast< std::add_pointer_t<QMqttClient::ClientError>>(_a[1]))); break;
        case 9: _t->publishFanState((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
