...
set(__qt_Mqtt_always_load_private_module ON)
set(__qt_Mqtt_save_QT_NO_PRIVATE_MODULE_WARNING ${QT_NO_PRIVATE_MODULE_WARNING})
set(QT_NO_PRIVATE_MODULE_WARNING ON)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6Mqtt-build.cmake" OPTIONAL)
if (Qt6Mqtt_FOUND
        AND NOT Qt6MqttPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_Mqtt_always_load_private_module
    ...
    find_package(Qt6MqttPrivate "6.9.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6MqttPrivate_FOUND)
        get_property(Qt6MqttPrivate_warning_shown GLOBAL PROPERTY
            Qt6MqttPrivate_warning_shown
        )
        if(NOT Qt6MqttPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6MqttPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6MqttPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
set(QT_NO_PRIVATE_MODULE_WARNING ${__qt_Mqtt_save_QT_NO_PRIVATE_MODULE_WARNING})
unset(__qt_Mqtt_save_QT_NO_PRIVATE_MODULE_WARNING)
unset(__qt_Mqtt_always_load_private_module)
...
if (NOT QT_NO_CREATE_TARGETS AND Qt6Mqtt_FOUND)
    ...
    if(NOT Qt6Mqtt_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt6Mqtt_DEFINITIONS)
        ...
        endforeach()
        set(Qt6Mqtt_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
...
if (TARGET Qt6::Mqtt)
    ...
    if(NOT "Mqtt" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
